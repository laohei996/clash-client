...
```bash
$ docker build -t clash-for-linux .
```

### 运行容器

```bash
$ docker run -d --restart=always --name clash -p 9090:9090 -p 7890:7890 -p 7891:7891 -e CLASH_URL="your_subscription_url" clash-for-linux
```
